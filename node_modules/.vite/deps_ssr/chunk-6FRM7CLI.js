import {
  inferRemoteSize
} from "./chunk-2VRKA6UW.js";
import {
  isRemoteAllowed
} from "./chunk-IEIBBQNB.js";
import {
  shorthash
} from "./chunk-LOGPQGUP.js";
import {
  isRemotePath,
  joinPaths,
  removeQueryString
} from "./chunk-Z45NPJWO.js";
import {
  AstroError,
  errors_data_exports
...
init_define_globalThis_process_env();
init_define_process_env();
var VIRTUAL_MODULE_ID = "astro:assets";
var RESOLVED_VIRTUAL_MODULE_ID = "\0" + VIRTUAL_MODULE_ID;
var VIRTUAL_GET_IMAGE_ID = "virtual:astro:get-image";
var RESOLVED_VIRTUAL_GET_IMAGE_ID = "\0" + VIRTUAL_GET_IMAGE_ID;
var VIRTUAL_IMAGE_STYLES_ID = "virtual:astro:image-styles.css";
var RESOLVED_VIRTUAL_IMAGE_STYLES_ID = "\0" + VIRTUAL_IMAGE_STYLES_ID;
...
// node_modules/astro/dist/assets/layout.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      ...
      const error = new AstroError(errors_data_exports.InvalidImageService);
      error.cause = e;
      throw error;
    });
...
async function getImage(options, imageConfig) {
  if (!options || typeof options !== "object") {
    throw new AstroError({
      ...errors_data_exports.ExpectedImageOptions,
      message: errors_data_exports.ExpectedImageOptions.message(JSON.stringify(options))
    });
  }
  ...
  if (isImageMetadata(options)) {
    throw new AstroError(errors_data_exports.ExpectedNotESMImage);
  }
  ...
  if (resolvedOptions.inferSize) {
    ...
    if (isRemoteImage(resolvedOptions.src) && isRemotePath(resolvedOptions.src)) {
      if (!isRemoteAllowed(resolvedOptions.src, imageConfig)) {
        throw new AstroError({
          ...errors_data_exports.RemoteImageNotAllowed,
          message: errors_data_exports.RemoteImageNotAllowed.message(resolvedOptions.src)
        });
      }
...
// node_modules/astro/dist/assets/utils/hash.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();

// node_modules/astro/dist/assets/utils/deterministic-string.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();
...
//# sourceMappingURL=chunk-6FRM7CLI.js.map
