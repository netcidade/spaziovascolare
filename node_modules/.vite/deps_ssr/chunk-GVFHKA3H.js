...
// node_modules/astro/dist/transitions/cssesc.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();
...
init_define_globalThis_process_env();
init_define_process_env();
var EASE_IN_OUT_QUART = "cubic-bezier(0.76, 0, 0.24, 1)";
function slide({
  duration
} = {}) {
  return {
...
// node_modules/astro/dist/runtime/server/transition.js
var transitionNameMap = /* @__PURE__ */ new WeakMap();
...
var getAnimations = (name) => {
  if (name === "fade") return fade();
  if (name === "slide") return slide();
  if (typeof name === "object") return name;
};
var addPairs = (animations, stylesheet) => {
...
var ViewTransitionStyleSheet = class {
  modern = [];
  fallback = [];
  scope;
  name;
...
//# sourceMappingURL=chunk-GVFHKA3H.js.map
