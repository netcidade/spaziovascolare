import {
  ...
  matchAllRoutes,
  routeComparator
} from "./chunk-KD7ABTRK.js";
import {
  Pipeline,
  findRouteToRewrite,
  getProps
} from "./chunk-PAKFPEJI.js";
import "./chunk-D4U6XPBB.js";
import "./chunk-J4QMGZNF.js";
import "./chunk-HAFW5F4N.js";
import "./chunk-BDYKFCAO.js";
import {
  newNodePool
} from "./chunk-C6CIJVMS.js";
import {
  queueRenderingEnabled
} from "./chunk-KDHD2USM.js";
import {
  HTMLStringCache
} from "./chunk-OXLQCLZM.js";
import "./chunk-VUUZECRF.js";
import "./chunk-GVFHKA3H.js";
import "./chunk-GSVIDLLM.js";
import "./chunk-QF6GMXFP.js";
import "./chunk-4DU34QGE.js";
import "./chunk-PYWK5OID.js";
import "./chunk-Y3KCRQST.js";
import "./chunk-ZEWIURSN.js";
import "./chunk-STGKB6CW.js";
import "./chunk-JMXJCI3S.js";
import "./chunk-HTFZH2OR.js";
import "./chunk-CVXNHYZZ.js";
import "./chunk-K5YRUHQY.js";
import "./chunk-3C2TUJPP.js";
import "./chunk-SI3LEWOE.js";
import "./chunk-ACTHJLYT.js";
import "./chunk-CR46HLCO.js";
import "./chunk-UI54HI3C.js";
import "./chunk-L6YMUYAO.js";
import "./chunk-S3NXP5Y3.js";
import "./chunk-W5OYJRDO.js";
import "./chunk-K7R6D5YG.js";
import "./chunk-BA7OZ3KE.js";
import "./chunk-EV2HKNXH.js";
import "./chunk-BSZJJDHH.js";
import "./chunk-WSAXZJT2.js";
import "./chunk-Q2U4AE3K.js";
import {
  s
} from "./chunk-5ZHQYUIL.js";
import "./chunk-JL2WL2Y6.js";
import "./chunk-WDRNXV4L.js";
import "./chunk-FQE2ZCDX.js";
import "./chunk-D4EPHHYI.js";
import {
  ASTRO_VERSION
} from "./chunk-H672BWDB.js";
import "./chunk-PUYLG7XE.js";
import {
  getCustom404Route,
  getCustom500Route,
  routeIsRedirect
} from "./chunk-QOFNKQNG.js";
import "./chunk-IEIBBQNB.js";
import "./chunk-LOGPQGUP.js";
import "./chunk-Z45NPJWO.js";
import "./chunk-JMGHSZHP.js";
import {
  MiddlewareNoDataOrNextCalled,
  MiddlewareNotAResponse,
  NoMatchingStaticPathFound,
  isAstroError
} from "./chunk-JYSSCBAJ.js";
import "./chunk-4ECSYGN6.js";
import {
...
init_define_globalThis_process_env();
init_define_process_env();
var NonRunnablePipeline = class _NonRunnablePipeline extends Pipeline {
  getName() {
    return "NonRunnablePipeline";
  }
  static create({ logger, manifest: manifest2, streaming }) {
    ...
    const pipeline = new _NonRunnablePipeline(
      logger,
      manifest2,
      "development",
      manifest2.renderers,
    ...
    if (queueRenderingEnabled(manifest2.experimentalQueuedRendering)) {
      pipeline.nodePool = newNodePool(manifest2.experimentalQueuedRendering);
...
init_define_globalThis_process_env();
init_define_process_env();
function getSortedPreloadedMatches({ matches, manifest: manifest2 }) {
...
function preloadAndSetPrerenderStatus({
  ...
  for (const route of matches) {
    const filePath = new URL(`./${route.component}`, manifest2.rootDir);
...
// node_modules/astro/dist/core/routing/dev.js
async function matchRoute(pathname, routesList, pipeline, manifest2) {
  ...
  if (altPathname !== pathname) {
    return await matchRoute(altPathname, routesList, pipeline, manifest2);
  }
  if (matches.length) {
...
${NoMatchingStaticPathFound.hint(possibleRoutes)}`
  ...
  if (custom404) {
    const filePath = new URL(`./${custom404.component}`, manifest2.rootDir);
    return {
      route: custom404,
      filePath,
      resolvedPathname: pathname
...
// node_modules/astro/dist/core/errors/dev/runtime.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();

// node_modules/astro/dist/core/util-runtime.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();
...
var DevApp = class extends BaseApp {
  logger;
  constructor(manifest2, streaming = true, logger) {
    super(manifest2, streaming, logger);
    this.logger = logger;
  }
  createPipeline(streaming, manifest2, logger) {
...
//# sourceMappingURL=astro_app_entrypoint_dev.js.map
