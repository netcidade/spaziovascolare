...
init_define_globalThis_process_env();
init_define_process_env();
var ClientOnlyPlaceholder2 = "astro-client-only";
var jsxQueueStats = {
  vnodeCount: 0,
  elementCount: 0,
  componentCount: 0,
...
Did you forget to import the component or is it possible there is a typo?`
  ...
  if (typeof vnode.type === "string" && vnode.type !== ClientOnlyPlaceholder2) {
...
function renderHTMLElement(vnode, _result, queue, pool, stack, parent, metadata) {
  ...
  if (children != null && children !== "") {
    const processedChildren = prerenderElementChildren2(tag, children, queue.htmlStringCache);
...
function prerenderElementChildren2(tag, children, htmlStringCache) {
  if (typeof children === "string" && (tag === "style" || tag === "script")) {
...
//# sourceMappingURL=chunk-VUUZECRF.js.map
