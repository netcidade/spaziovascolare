...
// node_modules/astro/dist/assets/utils/vendor/image-size/types/jxl.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();

// node_modules/astro/dist/assets/utils/vendor/image-size/types/jxl-stream.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();

// node_modules/astro/dist/assets/utils/vendor/image-size/utils/bit-reader.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();
var BitReader = class {
...
async function imageMetadata(data, src) {
  ...
  try {
    ...
    throw new AstroError({
      ...errors_data_exports.NoImageMetadata,
      message: errors_data_exports.NoImageMetadata.message(src)
    });
  }
...
async function inferRemoteSize(url, imageConfig) {
  if (!URL.canParse(url)) {
    throw new AstroError({
      ...errors_data_exports.FailedToFetchRemoteImageDimensions,
      message: errors_data_exports.FailedToFetchRemoteImageDimensions.message(url)
    });
  }
  ...
  if (allowlistConfig && !isRemoteAllowed(url, allowlistConfig)) {
    throw new AstroError({
      ...
      message: errors_data_exports.RemoteImageNotAllowed.message(url)
    });
  }
  ...
  throw new AstroError({
    ...errors_data_exports.NoImageMetadata,
    message: errors_data_exports.NoImageMetadata.message(url)
  });
}
...
//# sourceMappingURL=chunk-2VRKA6UW.js.map
